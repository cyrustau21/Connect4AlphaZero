...
class Connect4NNet():
    def __init__(self, game, args):
        ...
        h_conv1 = Activation('elu')(BatchNormalization(axis=3)(Conv2D(args.num_channels, 3, padding='same', use_bias=False)(x_image)))         # batch_size  x board_x x board_y x num_channels
        ...
        self.model.compile(loss=['mean_squared_logarithmic_error','mean_squared_error'], optimizer=Adam(args.lr))
